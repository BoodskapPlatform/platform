...
public class SentNotificationId implements Serializable{
	...
	private static final long serialVersionUID = -7700369065861385759L;
	...
	public SentNotificationId() {
	}

	public SentNotificationId(String domainKey, String notificationId) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SentNotificationId other = (SentNotificationId) obj;
		if (domainKey == null) {
