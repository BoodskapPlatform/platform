...
public class PropertyId implements Serializable {
	...
	private static final long serialVersionUID = -467357100093801428L;

	@Column(name="domainkey", length=16)
	private String domainKey;

	@Column(name="target", length=40)
	...
	public PropertyId(String domainKey, PropertyTarget target, String targetId, String name) {
