...
public class DynamicStorageFactory implements IDynamicStorageFactory {
	
	private IDynamicStorageFactory implementation;
	private DynamicStorage storage;

	public DynamicStorageFactory() {
	}

	public IDynamicStorageFactory getImplementation() {
		return implementation;
	}

	public void setImplementation(IDynamicStorageFactory implementation) {
		this.implementation = implementation;
		storage = new DynamicStorage(implementation.getDynamicStorage());
	}
