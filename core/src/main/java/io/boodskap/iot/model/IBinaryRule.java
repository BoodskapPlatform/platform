...
public interface IBinaryRule extends IRule {
	...
	public static Class<? extends IBinaryRule> clazz() {
		return dao().clazz();
	}
	
	public static IBinaryRule create(String domainKey, String type) {
		return dao().create(domainKey, type);
	}

	public static IBinaryRule find(String domainKey, String type) {
