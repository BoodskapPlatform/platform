...
public interface INamedRule extends IRule  {
	...
	public static Class<? extends INamedRule> clazz() {
		return dao().clazz();
	}
	
	public static INamedRule create(String domainKey, String name) {
		return dao().create(domainKey, name);
	}

	public static INamedRule find(String domainKey, String name) {
