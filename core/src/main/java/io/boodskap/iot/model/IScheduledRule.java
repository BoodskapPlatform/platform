...
public interface IScheduledRule extends IRule {
	...
	public static Class<? extends IScheduledRule> clazz() {
		return dao().clazz();
	}
	
	public static IScheduledRule create(String domainKey, String ruleId) {
		return dao().create(domainKey, ruleId);
	}

	public static IScheduledRule find(String domainKey, String ruleId) {
