...
public class DatabaseMetaData extends AbstractDomainObject implements IDatabaseMetaData {
	...
	private List<IDatabaseTable> tables = new ArrayList<>();
	private List<IDatabaseTable> views = new ArrayList<>();
	private List<IDatabaseTable> systables = new ArrayList<>();
	private List<IDatabaseTable> gbltempTables = new ArrayList<>();
	private List<IDatabaseTable> lcltempTables = new ArrayList<>();
	private List<IDatabaseTable> aliases = new ArrayList<>();
	private List<IDatabaseTable> synonyms = new ArrayList<>();
	...
	public List<IDatabaseTable> getViews() {
		return views;
	}
	...
	public List<IDatabaseTable> getSynonyms() {
		return synonyms;
	}
