...
public interface IAssetGroupMember extends IGroupMember {
	...
	public static Class<? extends IAssetGroupMember> clazz() {
		return dao().clazz();
	}
	
	public static IAssetGroupMember create(String domainKey, String ownerAssetId, String groupId, String memberId) {
		return dao().create(domainKey, ownerAssetId, groupId, memberId);
	}

	public static IAssetGroupMember find(String domainKey, String ownerAssetId, String groupId, String memberId) {
