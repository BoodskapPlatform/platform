...
public interface OutgoingVoiceDAO<T extends IOutgoingVoice> extends DAO<T> {
	
	public static <T extends IOutgoingVoice> OutgoingVoiceDAO<T> get() {
		return BoodskapSystem.storage().getOutgoingVoiceDAO();
	}
