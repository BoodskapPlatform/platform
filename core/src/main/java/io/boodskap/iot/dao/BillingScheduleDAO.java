...
public interface BillingScheduleDAO<T extends IBillingSchedule> extends DAO<T> {
	
	public static BillingScheduleDAO<IBillingSchedule> get() {
		return BoodskapSystem.storage().getBillingScheduleDAO();
	}
	
	public T get(String domainKey, String targetDomain, String scheduleId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String targetDomin, String scheduleId, int page, int pageSize) throws StorageException;
