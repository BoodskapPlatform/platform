...
public interface DomainUserGroupMemberDAO<T extends IDomainUserGroupMember> extends DAO<T>{
	
	public static <T extends IDomainUserGroupMember> DomainUserGroupMemberDAO<T> get() {
		return BoodskapSystem.storage().getDomainUserGroupMemberDAO();
	}
	
	public T create(String domainKey, String groupId, String userId) throws StorageException;

	public T get(String domainKey, String groupId, String userId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String groupId, String userId, int page, int pageSize) throws StorageException;
