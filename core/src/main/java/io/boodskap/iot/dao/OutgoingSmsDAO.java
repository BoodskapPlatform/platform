...
public interface OutgoingSmsDAO<T extends IOutgoingSms> extends DAO<T> {
	
	public static <T extends IOutgoingSms> OutgoingSmsDAO<T> get() {
		return BoodskapSystem.storage().getOutgoingSmsDAO();
	}
