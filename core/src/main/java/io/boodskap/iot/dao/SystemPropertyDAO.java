...
public interface SystemPropertyDAO<T extends ISystemProperty>{
	
	public static SystemPropertyDAO<ISystemProperty> get() {
		return BoodskapSystem.storage().getSystemPropertyDAO();
	}
	...
	public Collection<T> listNext(String name, int page, int pageSize) throws StorageException;
