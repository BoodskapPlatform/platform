...
public interface FCMDeviceDAO<T extends IFCMDevice> extends DAO<T> {
	
	public static <T extends IFCMDevice> FCMDeviceDAO<T> get() {
		return BoodskapSystem.storage().getFCMDeviceDAO();
	}
