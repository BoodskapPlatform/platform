...
public interface DomainUserGroupDAO<T extends IDomainUserGroup> extends DAO<T> {
	
	public static <T extends IDomainUserGroup> DomainUserGroupDAO<T> get() {
		return BoodskapSystem.storage().getDomainUserGroupDAO();
	}
