...
public interface DomainGroovyClassDAO<T extends IDomainGroovyClass> extends DAO<T> {
	
	public static DomainGroovyClassDAO<IDomainGroovyClass> get() {
		return BoodskapSystem.storage().getDomainGroovyClassDAO();
	}

	public T create(String domainKey, String loader, String pkg, String name);
	
	public T get(String domainKey, String loader, String pkg, String name, boolean loadContent) throws StorageException;
	...
	public Collection<T> listNextClasses(String domainKey, String loader, String pkg, String name, int page, int pageSize) throws StorageException;
	...
	public Collection<T> listNextPackageClasses(String domainKey, String loader, String pkg, String name, int page, int pageSize) throws StorageException;
