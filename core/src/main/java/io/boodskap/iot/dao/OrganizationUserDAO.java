...
public interface OrganizationUserDAO<T extends IOrganizationUser> extends DAO<T> {
	
	public static <T extends IOrganizationUser> OrganizationUserDAO<T> get() {
		return BoodskapSystem.storage().getOrganizationUserDAO();
	}
	
	public T create(String domainKey, String orgId, String userId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String orgId, String userId, int page, int pageSize) throws StorageException;
