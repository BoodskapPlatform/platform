...
public interface OTADeviceBatchMemberDAO<T extends IOTADeviceBatchMember> extends DAO<T> {
	
	public static <T extends IOTADeviceBatchMember> OTADeviceBatchMemberDAO<T> get() {
		return BoodskapSystem.storage().getOTADeviceBatchMemberDAO();
	}

	public T create(String domainKey, String batchId, String deviceId) throws StorageException;

	public T get(String domainKey, String batchId, String deviceId) throws StorageException;
