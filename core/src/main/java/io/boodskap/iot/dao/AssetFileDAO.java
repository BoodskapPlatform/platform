...
public interface AssetFileDAO<T extends IAssetFile> extends DAO<T> {
	
	public static AssetFileDAO<IAssetFile> get() {
		return BoodskapSystem.storage().getAssetFileDAO();
	}

	public T get(String domainKey, String assetId, String fileId) throws StorageException;
	...
	public Collection<T> list(boolean load, String domainKey, String assetId, int page, int pageSize) throws StorageException;

	public Collection<T> listNext(boolean load, String domainKey, String assetId, String fileId, int page, int pageSize) throws StorageException;

	public Collection<T> search(boolean load, String domainKey, String assetId, String query, int pageSize) throws StorageException;
