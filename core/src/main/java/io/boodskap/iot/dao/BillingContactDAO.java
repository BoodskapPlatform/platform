...
public interface BillingContactDAO<T extends IBillingContact> extends DAO<T> {
	
	public static BillingContactDAO<IBillingContact> get() {
		return BoodskapSystem.storage().getBillingContactDAO();
	}
	
	public T get(String domainKey, String targetDomain, String contactId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String targetDomain, String contactId, int page, int pageSize) throws StorageException;
