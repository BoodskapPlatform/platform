...
public interface NamedRuleDAO<T extends INamedRule> extends DAO<T> {
	
	public static <T extends INamedRule> NamedRuleDAO<T> get() {
		return BoodskapSystem.storage().getNamedRuleDAO();
	}
	...
	public Collection<T> listNext(boolean load, String domainKey, String name, int page, int pageSize) throws StorageException;
