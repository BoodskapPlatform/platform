...
public interface CameraDeviceDAO<T extends ICameraDevice> extends DAO<T> {
	
	public static <T extends ICameraDevice> CameraDeviceDAO<T> get() {
		return BoodskapSystem.storage().getCameraDeviceDAO();
	}

	public T get(String domainKey, String deviceId, String camera) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String deviceId, int page, int pageSize) throws StorageException;
