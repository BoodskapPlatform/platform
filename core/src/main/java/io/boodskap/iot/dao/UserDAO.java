...
public interface UserDAO<T extends IUser> extends DAO<T> {
	
	public static UserDAO<IUser> get() {
		return BoodskapSystem.storage().getUserDAO();
	}
	
	public T create(String domainKey, String userId) throws StorageException;

	public T get(String userId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String userId, int page, int pageSize) throws StorageException;
