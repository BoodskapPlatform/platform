...
public interface OTAModelBatchMemberDAO<T extends IOTAModelBatchMember> extends DAO<T> {
	
	public static <T extends IOTAModelBatchMember> OTAModelBatchMemberDAO<T> get() {
		return BoodskapSystem.storage().getOTAModelBatchMemberDAO();
	}

	public T create(String domainKey, String batchId, String fromModel, String deviceId) throws StorageException;

	public T get(String domainKey, String batchId, String fromModel, String deviceId) throws StorageException;
	...
	public default Collection<T> list(String domainKey, String batchId, int page, int pageSize) throws StorageException{
		return list(domainKey, batchId, OTAState.values(), page, pageSize);
	}

	public default Collection<T> listNext(String domainKey, String batchId, String deviceId, int page, int pageSize) throws StorageException{
		return listNext(domainKey, batchId, OTAState.values(), deviceId, page, pageSize);
	}

	public default Collection<T> search(String domainKey, String batchId, String query, int pageSize) throws StorageException{
