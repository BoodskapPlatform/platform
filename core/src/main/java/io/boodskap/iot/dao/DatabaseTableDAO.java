...
public interface DatabaseTableDAO<T extends IDatabaseTable> extends DAO<T> {

	public static <T extends IDatabaseTable> DatabaseTableDAO<T> get() {
		return BoodskapSystem.storage().getDatabaseTableDAO();
	}
	...
	public T get(String domainKey, String metaDataId, String table);
