...
public interface SentEmailDAO<T extends ISentEmail> extends DAO<T> {
	
	public static <T extends ISentEmail> SentEmailDAO<T> get() {
		return BoodskapSystem.storage().getSentEmailDAO();
	}
