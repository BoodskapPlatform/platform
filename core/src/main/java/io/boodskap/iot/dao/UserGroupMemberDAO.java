...
public interface UserGroupMemberDAO<T extends IUserGroupMember> extends DAO<T> {
	
	public static <T extends IUserGroupMember> UserGroupMemberDAO<T> get() {
		return BoodskapSystem.storage().getUserGroupMemberDAO();
	}

	public T create(String domainKey, String ownerUserId, String groupId, String memberUserId) throws StorageException;

	public long count(String domainKey, String userId, String groupId) throws StorageException;

	public T get(String domainKey, String ownerUserId, String groupId, String memberUserId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String ownerUserId, String groupId, String memberUserId, int page, int pageSize) throws StorageException;
