...
public interface OutgoingFCMDAO<T extends IOutgoingFCM> extends DAO<T> {
	
	public static <T extends IOutgoingFCM> OutgoingFCMDAO<T> get() {
		return BoodskapSystem.storage().getOutgoingFCMDAO();
	}
