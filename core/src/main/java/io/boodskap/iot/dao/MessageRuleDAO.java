...
public interface MessageRuleDAO<T extends IMessageRule> extends DAO<T> {
	
	public static <T extends IMessageRule> MessageRuleDAO<T> get() {
		return BoodskapSystem.storage().getMessageRuleDAO();
	}
	...
	public Collection<T> listNext(boolean load, String domainKey, String specId, int page, int pageSize) throws StorageException;
