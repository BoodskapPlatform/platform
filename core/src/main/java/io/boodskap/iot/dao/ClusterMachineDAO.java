...
public interface ClusterMachineDAO<T extends IClusterMachine> {
	
	public static ClusterMachineDAO<IClusterMachine> get() {
		return BoodskapSystem.storage().getClusterMachineDAO();
	}
	...
	public T get(String domainKey, String targetDomainKey, String clusterId, String machineId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String targetDomainKey, String clusterId, String machineId, int page, int pageSize) throws StorageException;
