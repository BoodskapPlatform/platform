...
public interface ClusterDAO<T extends ICluster> {
	
	public static ClusterDAO<ICluster> get() {
		return BoodskapSystem.storage().getClusterDAO();
	}
	...
	public T get(String domainKey, String targetDomainKey, String clusterId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String targetDomainKey, String clusterId, int page, int pageSize) throws StorageException;
