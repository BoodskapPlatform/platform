...
public interface SentVoiceDAO<T extends ISentVoice> extends DAO<T> {
	
	public static <T extends ISentVoice> SentVoiceDAO<T> get() {
		return BoodskapSystem.storage().getSentVoiceDAO();
	}
