...
public interface ReportedDeviceDAO<T extends IReportedDevice> extends DAO<T> {
	
	public static <T extends IReportedDevice> ReportedDeviceDAO<T> get() {
		return BoodskapSystem.storage().getReportedDeviceDAO();
	}
