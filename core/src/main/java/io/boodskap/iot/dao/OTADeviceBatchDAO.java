...
public interface OTADeviceBatchDAO<T extends IOTADeviceBatch> extends DAO<T>{
	
	public static <T extends IOTADeviceBatch> OTADeviceBatchDAO<T> get() {
		return BoodskapSystem.storage().getOTADeviceBatchDAO();
	}
