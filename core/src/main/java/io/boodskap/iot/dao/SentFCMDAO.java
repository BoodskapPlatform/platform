...
public interface SentFCMDAO<T extends ISentFCM> extends DAO<T> {
	
	public static <T extends ISentFCM> SentFCMDAO<T> get() {
		return BoodskapSystem.storage().getSentFCMDAO();
	}
