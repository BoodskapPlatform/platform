...
public interface OTAModelBatchDAO<T extends IOTAModelBatch> extends DAO<T> {
	
	public static <T extends IOTAModelBatch> OTAModelBatchDAO<T> get() {
		return BoodskapSystem.storage().getOTAModelBatchDAO();
	}

	public T create(String domainKey, String batchId, String fromModel) throws StorageException;

	public T get(String domainKey, String batchId, String fromModel) throws StorageException;
