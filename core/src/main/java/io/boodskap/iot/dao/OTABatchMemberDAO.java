...
public interface OTABatchMemberDAO<T extends IOTABatchMember> extends DAO<T> {
	
	public static <T extends IOTABatchMember> OTABatchMemberDAO<T> get() {
		return BoodskapSystem.storage().getOTABatchMemberDAO();
	}
