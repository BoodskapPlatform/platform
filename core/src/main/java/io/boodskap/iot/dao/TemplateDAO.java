...
public interface TemplateDAO<T extends ITemplate> extends DAO<T> {
	
	public static <T extends ITemplate> TemplateDAO<T> get() {
		return BoodskapSystem.storage().getTemplateDAO();
	}
