...
public interface OTAModelVersionBatchDAO<T extends IOTAModelVersionBatch> extends DAO<T> {
	
	public static <T extends IOTAModelVersionBatch> OTAModelVersionBatchDAO<T> get() {
		return BoodskapSystem.storage().getOTAModelVersionBatchDAO();
	}

	public T create(String domainKey, String batchId, String fromModel, String fromVersion) throws StorageException;

	public T get(String domainKey, String batchId, String fromModel, String fromVersion) throws StorageException;
