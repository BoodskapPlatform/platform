...
public interface RecordDAO<T extends IRecord> extends DAO<T>{
	
	public static <T extends IRecord> RecordDAO<T> get() {
		return BoodskapSystem.dynamicStorage().getRecordDAO();
	}
	
	public T create(String domainKey, String specId, String recordId) throws StorageException;
	
	public T get(String domainKey, String specId, String recordId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String specId, String recordId, int page, int pageSize) throws StorageException;
