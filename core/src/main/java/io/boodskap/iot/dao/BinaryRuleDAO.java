...
public interface BinaryRuleDAO<T extends IBinaryRule> extends DAO<T> {
	
	public static BinaryRuleDAO<IBinaryRule> get() {
		return BoodskapSystem.storage().getBinaryRuleDAO();
	}

	public T get(String domainKey, String type) throws StorageException;
	...
	public Collection<T> listNext(boolean load, String domainKey, String type, int page, int pageSize) throws StorageException;
