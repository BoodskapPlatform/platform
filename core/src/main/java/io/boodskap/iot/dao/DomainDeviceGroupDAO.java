...
public interface DomainDeviceGroupDAO<T extends IDomainDeviceGroup> extends DAO<T> {
	
	public static <T extends IDomainDeviceGroup> DomainDeviceGroupDAO<T> get() {
		return BoodskapSystem.storage().getDomainDeviceGroupDAO();
	}
