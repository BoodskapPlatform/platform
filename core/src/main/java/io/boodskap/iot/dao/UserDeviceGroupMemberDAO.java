...
public interface UserDeviceGroupMemberDAO<T extends IUserDeviceGroupMember> extends DAO<T> {
	
	public static <T extends IUserDeviceGroupMember> UserDeviceGroupMemberDAO<T> get() {
		return BoodskapSystem.storage().getUserDeviceGroupMemberDAO();
	}
	
	public T create(String domainKey, String ownerUserId, String groupId, String memberDeviceId) throws StorageException;
	
	public long count(String domainKey, String ownerUserId, String groupId) throws StorageException;

	public T get(String domainKey, String ownerUserId, String groupId, String memberDeviceId) throws StorageException;
	...
	public Collection<T> listNext(String domainKey, String ownerUserId, String groupId, String memberDeviceId, int page, int pageSize) throws StorageException;
