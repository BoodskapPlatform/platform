...
public interface OfflineStreamDAO<T extends IOfflineStream> extends DAO<T> {
	
	public static <T extends IOfflineStream> OfflineStreamDAO<T> get() {
		return BoodskapSystem.storage().getOfflineStreamDAO();
	}

	public T create(String domainKey, String deviceId, String camera, String session, int frame) throws StorageException;

	public T get(String domainKey, String deviceId, String camera, String session, int frame) throws StorageException;
	...
	public Collection<T> list(String domainKey, String deviceId, String camera, String session, int page, int pageSize) throws StorageException;
