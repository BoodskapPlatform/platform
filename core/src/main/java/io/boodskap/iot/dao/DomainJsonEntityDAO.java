...
public interface DomainJsonEntityDAO<T extends IDomainJsonEntity> extends DAO<T> {
	
	public static <T extends IDomainJsonEntity> DomainJsonEntityDAO<T> get() {
		return BoodskapSystem.storage().getDomainJsonEntityDAO();
	}
